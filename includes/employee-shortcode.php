...
function lm_employee_swiper_shortcode($atts) {
    ...
    wp_enqueue_script('lm-employee-swiper-js', plugin_dir_url(__FILE__) . 'js/employee-swiper.js', array('jquery'), '1.0', true);
    ...
    ?>
    <!-- Swiper.js container -->
    <div class="swiper-container lm-employee-swiper">
